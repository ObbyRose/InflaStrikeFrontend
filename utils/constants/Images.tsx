  ...
  return (
    <Box className={cn(className)}>
      <Svg
        ...
        <Path stroke="#ADB8CC" strokeWidth={1.5} d="M94.75 136H113.25V185.5H94.75z" />
        <Path
          ...
          strokeWidth={1.5}
        />
        <Rect x={111.45} y={116.972} width={48} height={2} rx={1} fill="#ADB8CC" />
        <Rect x={111.45} y={110.972} width={48} height={2} rx={1} fill="#ADB8CC" />
        <Rect x={111.45} y={122.972} width={24} height={2} rx={1} fill="#ADB8CC" />
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        <Mask
          ...
          width={81}
          height={87}>
          <Path d="M24 53.972h47.7c18.225 0 33 14.775 33 33v52.8H24v-85.8z" fill="#fff" />
        </Mask>
        <G mask="url(#a)">
          <Path
    ...
    <Box className={cn(className)}>
      <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" fill="none">
        ...
        <Path
          ...
          fill="#4A3EF6"
        />
        <Rect x={75} y={114} width={48} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        <Rect x={74.8059} y={122} width={48} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        <Rect x={74.8059} y={130} width={24} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        <Circle cx={100} cy={170} r={4} fill="#fff" fillOpacity={0.16206} />
        <Rect x={94} y={28} width={15} height={2} rx={1} fill="#fff" fillOpacity={0.164458} />
        ...
        <Path
          ...
          strokeWidth={1.5}
        />
        <Rect x={120} y={102} width={39} height={16} rx={8} stroke="#ADB8CC" strokeWidth={1.5} />
        <Rect
          x={123.849}
          y={118}
          width={32}
        ...
        <Path
          ...
          strokeLinecap="square"
        />
        <Path d="M97.142 176.267S84.43 189.272 83 193" stroke="#ADB8CC" strokeWidth={1.5} />
      </Svg>
    </Box>
  );
};
...
export const IM_ProcessingVerification = ({ className }: ImageProps) => {
  return (
    <Box className={cn(className)}>
      <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 208 200" fill="none">
        <Path d="M44.778 96.163S37.208 93.58 10.82 104" stroke="#ADB8CC" strokeWidth={1.5} />
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        <Path
          ...
          mask="url(#a)"
        />
        <Ellipse cx={139.821} cy={103} rx={29.9615} ry={30} fill="#000" fillOpacity={0.197626} />
        <Path
        ...
        <Mask
          ...
          width={45}
          height={52}>
          <Rect x={52.9321} y={71} width={43.9435} height={52} rx={4} fill="#fff" />
        </Mask>
        <G mask="url(#b)">
          <Path
            fillRule="evenodd"
    ...
    <Box className={cn(className)}>
      <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" fill="none">
        ...
        <Path
          ...
          fill="#4A3EF6"
        />
        <Rect x={80} y={56} width={40} height={40} rx={20} fill="url(#paint0_linear_835_5795)" />
        <Mask
          id="a"
          style={{
            maskType: 'luminance',
        ...
        <Rect x={85} y={110} width={37} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        <Rect x={85} y={116} width={37} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        ...
        <Path
          ...
          strokeLinejoin="round"
        />
        <Rect x={85} y={122} width={37} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        <Rect x={85} y={128} width={37} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        <Rect x={85} y={134} width={18} height={2} rx={1} fill="#fff" fillOpacity={0.304058} />
        <Circle cx={100} cy={170} r={4} fill="#fff" fillOpacity={0.16206} />
        <Rect x={94} y={28} width={15} height={2} rx={1} fill="#fff" fillOpacity={0.164458} />
        <Circle cx={92} cy={29} r={1} fill="#fff" fillOpacity={0.164458} />
        <Path
